...
const contactMethod = [
    ...
    },
    {
        icon: <Phone size={24} />,
        title: "Call Us",
        details: "+234 9047-592580",
        description: "Mon-Fri from 9am to 6pm",
    },
    {
        icon: <MapPin size={24} />,
        title: "Visit Us",
        details: "4, Off University Road Ilorin",
        description: "Feel Free to visit our office",
    },
    {
        icon: <Clock size={24} />,
        title: "Support Hours",
        details: "24/7 Avaliable",
        ...
        <section id='contact' className='py-20'>
            <div className='mx-auto container px-6'>
                ...
                <div className='text-center mb-16'>
                    <h2 className='text-4xl md:text-5xl font-bold text-white mb-6'>Get In<span className='text-fuchsia-500'> Touch</span></h2>
                    <p className='text-md text-gray-300 mx-auto max-w-3xl'> Have questions about RestMetrics? We're here to help you get the best sleep experience.
                    </p>
                </div>

                <div className='grid lg:grid-cols-2 mx-auto gap-12 max-w-6xl'>

                    {/* contact information */}

                    <div>
                        <h3 className='text-2xl font-bold text-white mb-8'>Contact Infomation</h3>
                            ...
                            {contactMethod.map((method, index) => {
                                return (
                                    <div key={index} className="bg-slate-800 rounded-xl p-6 hover:bg-slate-700 transition-colors">
                                        ...
                                        <p className="font-medium mb-1 text-fuchsia-500">{method.details}</p>
                    ...
                    <div className="bg-slate-800 rounded-2xl p-8">
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                    ...
                                    <textarea rows={5}  id="message" required placeholder="Tell us how we can help" className="w-full resize-none bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-fuchsia-500 transition-colors" />
                                </div>
